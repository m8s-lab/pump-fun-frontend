    ...
    "dark" ===
      ...
      this._options.debug &&
        (i ||
          ((i = !0),
          console.log(
            "Using CL v27.001 (internal id 3eb6c0e5 @ 2024-02-02T14:43:45.314Z)",
          ))),
      this._create();
  }
  setDebugMode(t) {
  ...
  _render(t) {
    ...
    const i = (function (t, e) {
      ...
      const o = new URL(`${t || ""}`, location.href).href,
        s = JSON.parse(
          '["bundles/runtime.b283dc97286bf865cf08.js","bundles/__LANG__.4716.e4ac74dfc9ec5374b00c.js","bundles/6150.bda60280b05cea478076.css","bundles/5142.2c34c8656148cc5203b7.js","bundles/library.97ddeff81f861d17f06e.js"]',
        ),
